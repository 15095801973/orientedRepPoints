...
if __name__ == '__main__':
    ...
    generate_json_labels('F:/360downloads/OrientedRepPoints-main/data/dota_1024/test_split',
                         'F:/360downloads/OrientedRepPoints-main/data/dota_1024/test_split/test_dota_tv.json', trainval=True)
    print('done!')
